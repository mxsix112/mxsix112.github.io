...
| 智能提示               | `alt+enter`      |
| 使用块环绕             | `ctrl+alt+t`     |
| 调出生成generate构造器 | `alt+inster`     |
| 复制指定行             | `ctrl+y`         |
| 切换下一行代码空位     | `shift+enter`    |
| 切换上一行             | `ctrl+alt+enter` |
...
| 说明                           | 快捷键         |
| ------------------------------ | -------------- |
| 批量修改指定变量名/方法名/类名 | `shift+F6`     |
| 抽取代码重构方法               | `ctrl+alt+m`   |
| 重写父类方法                   | `ctrl+o`       |
| 实现接口                       | `ctrl+i`       |
| 选中结构大小写切换             | `ctrl+shift+u` |
| 批量导包                       | `ctrl+alt+o`   |
| 格式化代码                     | `ctrl+alt+l`   |
...
> 作者: mxsix112  
> URL: https://notes.hifo.fun/ideashortcuts/  
